...
// rpc URL 
export const RPC_URL = `https://polygon-mumbai.g.alchemy.com/v2/${process.env.PROJECT_ID}`;//`https://eth-goerli.g.alchemy.com/v2/${PROJECT_ID}`;
// API Base URL
export const baseURL = 'https://idq-fufksazl0-papiasharmin.vercel.app';
// PINTA API Base URL
